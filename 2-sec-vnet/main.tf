...
# VARIABLES
#############################################################################
#CREATING A SECOND VPC FOR SEC TEAM
...
#CREATING AN AZURE ACTIVE DIRECTORY SERVICE PRINCIPAL (ACCESS CREDENTIAL)
...
## ASIGN THE ROLE TO THE SERVICE PRINCIPAL 
